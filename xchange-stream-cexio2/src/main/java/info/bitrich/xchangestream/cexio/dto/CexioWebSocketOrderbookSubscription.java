...
public class CexioWebSocketOrderbookSubscription extends CexioWebSocketPairSubscription {
  ...
  public CexioWebSocketOrderbookSubscription(
      @JsonProperty(PROP_PAIR) String[] pair, @JsonProperty(PROP_DEPTH) int depth) {
    this(pair, true, depth);
  }

  public CexioWebSocketOrderbookSubscription(
      @JsonProperty(PROP_PAIR) String[] pair,
      @JsonProperty(PROP_SUBSCRIBE) boolean subscribe,
