...
public class BitfinexUtils {
    ...
    public static BitfinexOrderStatusResponse adaptOrderStatusResponse(BitfinexWebSocketAuthOrder order) {
        final String status = order.getOrderStatus() != null ? order.getOrderStatus().toLowerCase() : "";
