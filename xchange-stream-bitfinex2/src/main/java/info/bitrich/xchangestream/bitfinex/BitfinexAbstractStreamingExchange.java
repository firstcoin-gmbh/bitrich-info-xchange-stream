...
public abstract class BitfinexAbstractStreamingExchange extends BitfinexExchange
  ...
  public void remoteInit() throws IOException, ExchangeException {
    ...
    // out of Bitfinex's
    // pricePercision
    org.knowm.xchange.bitfinex.service.BitfinexMarketDataServiceRaw dataServiceV2 =
        new org.knowm.xchange.bitfinex.service.BitfinexMarketDataServiceRaw(this);
    Map<CurrencyPair, BigDecimal> lastPrices =
        Arrays.stream(dataServiceV2.getBitfinexTickers(currencyPairs))
            .map(org.knowm.xchange.bitfinex.service.BitfinexAdapters::adaptTicker)
    ...
    exchangeMetaData =
        BitfinexAdapters.adaptMetaData(
            ...
            symbolDetails.stream()
                .filter(d -> lastPrices.containsKey(adaptCurrencyPair(d.getPair())))
