...
public class BitfinexManualAuthExample {
  ...
  public static void main(String[] args) {
    ...
    try {
      final BitfinexStreamingTradeService tradeService =
          (BitfinexStreamingTradeService) exchange.getStreamingTradeService();
      final BitfinexStreamingAccountInfoService accountService =
          (BitfinexStreamingAccountInfoService) exchange.getStreamingAccountService();
