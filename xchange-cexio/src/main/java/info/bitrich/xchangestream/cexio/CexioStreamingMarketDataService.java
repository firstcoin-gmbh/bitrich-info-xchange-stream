...
import static info.bitrich.xchangestream.cexio.CexioStreamingExtendedRawService.MARKET_DATA_UPDATE_EVENT;
import static info.bitrich.xchangestream.cexio.CexioStreamingExtendedRawService.ORDERBOOK_SUBSCRIPTION_EVENT;
...
public class CexioStreamingMarketDataService implements StreamingMarketDataService {
    ...
    private final CexioStreamingExtendedRawService service;
    
    private final Map<CurrencyPair, CexioOrderbook> orderbooks = new HashMap<>();

    public CexioStreamingMarketDataService(CexioStreamingExtendedRawService service) {
	this.service = service;
    }

    @Override
    public Observable<OrderBook> getOrderBook(CurrencyPair currencyPair, Object... args) {
	final String channelName = CexioStreamingExtendedRawService.CHANNEL_ORDERBOOK;
