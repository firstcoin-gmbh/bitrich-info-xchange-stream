...
public interface StreamingTradeService {
     ...
     * {@link TradeService#getOpenOrders()}.</p>
     *
    ...
    default Observable<LimitOrder> getOpenOrders(Object... args) {
	throw new NotYetImplementedForExchangeException();
    }
    ...
    default Observable<UserTrade> getUserTrades(Object... args) {
	throw new NotYetImplementedForExchangeException();
    }
    
    default void placeLimitOrder(LimitOrder limitOrder) {
	throw new NotYetImplementedForExchangeException();
    }
